...
public class CreditCardUtils {
    ...
    /**
     * Todo: Make this smarter and better validity checks before converting
     * @param cardValidity
     * @return then integer from
     */
    public static int getCardMonth(String cardValidity) {
        String month = cardValidity.substring(0, 2);
        return Integer.parseInt(month);
    }

    public static int getCardYear(String cardValidity) {
